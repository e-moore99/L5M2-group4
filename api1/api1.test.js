...
describe("API 1 test cases", ()=> {
    ...
    // });
    // test("3. Test model input num: enter '404', 1969. Return 1969", () => {
    //     expect(modelToNum("404", 1969)).toBe(1969);
    // });
    test("4. Test invalid model char: enter 'Santa-Fe', 2012 return error", () => {
        expect(modelToNum("Santa-Fe", 2012)).toBe("error")
    });
